...
const models = [
    { value: "thaki-default", label: "ذكي 2.0 🤖", icon: XAIIcon, iconClass: "!text-neutral-300", description: "نموذج ذكي 2.0 المتطور", color: "glossyblack", vision: false, experimental: false, category: "مستقر" },
];
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="relative rounded-lg bg-neutral-100 dark:bg-neutral-900">
                        <Textarea
                            ref={inputRef}
                            placeholder={hasInteracted ? "اسأل سؤالاً جديداً... 💭" : "اسأل أي سؤال... 💭"}
                            value={input}
